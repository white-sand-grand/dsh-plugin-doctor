 ...
 */
export function renderMermaidGraph(installedNames, matrix, threshold) {
 ...
 */
export function renderLandscape(tiers, report, threshold, installedNames, sessionsScanned) {
